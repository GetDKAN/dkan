...
Feature: Recline
  ...
  Scenario: Viewing map preview
    ...
    When I click "Edit"
    And I fill in "edit-field-link-remote-file-und-0-filefield-dkan-remotefile-url" with "http://demo.getdkan.com/sites/default/files/Polling_Places_Madison_0.csv"
  ...
  Scenario: Viewing graph preview
    ...
    When I click "Edit"
    And I fill in "edit-field-link-remote-file-und-0-filefield-dkan-remotefile-url" with "http://demo.getdkan.com/sites/default/files/data_0.csv"
    And I press "edit-submit"
