...
Feature: Users with Editor, Content Creator or Site Manager roles should not have access to administration pages.
  ...
  Background:
    Given pages:
      ...
      | manage visualization chart bundle dependencies   | /admin/structure/entity-type/visualization/ve_chart/dependencies |
      ...
      | manage dkan_data_story content type dependencies | /admin/structure/types/manage/dkan-data-story/dependencies       |
      ...
      | manage data_dashboard content type dependencies  | /admin/structure/types/manage/data_dashboard/dependencies        |
      ...
      | manage dataset content type dependencies         | /admin/structure/types/manage/dataset/dependencies               |
      ...
      | manage resource content type dependencies        | /admin/structure/types/manage/resource/dependencies              |
      ...
      | manage group content type dependencies           | /admin/structure/types/manage/group/dependencies                 |
  ...
  Examples:
    ...
    | manage visualization chart bundle dependencies   |
    ...
    | manage dkan_data_story content type dependencies |
    ...
    | manage data_dashboard content type dependencies  |
    ...
    | manage dataset content type dependencies         |
