...
Feature: Resource
  ...
  Scenario: Import items on datastore of any resource
    ...
    And I fill in "edit-field-link-remote-file-und-0-filefield-dkan-remotefile-url" with "https://www.dropbox.com/s/uumenmrxxyrajtl/district_centerpoints_0.csv?dl=1"
    And I press "Save"
    When I click "Manage Datastore"
    And I press "Import"
