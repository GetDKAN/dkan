...
Feature: Site Manager administer groups
  ...
  Background:
    ...
    And datasets:
      ...
      | Dataset 06 | Group 02  | Count        | Celeste | Yes       | Test dataset counts        | 13 March 2015     | Education      |
      | Dataset 07 | Group 02  | Count        | Celeste | Yes       | Test dataset counts        | 10 September 2015 | Education      |
      | Dataset 08 | Group 02  | Count        | Celeste | Yes       | Test dataset counts        | 25 February 2014  | Education      |
      | Dataset 09 | Group 02  | Count        | Celeste | Yes       | Test dataset counts        | 13 September 2014 | Transportation |
      | Dataset 10 | Group 02  | Count        | Celeste | Yes       | Test dataset counts        | 10 October 2013   | Transportation |
  ...
  Scenario: View the list of datasets displayed with the search result view mode
    ...
    Then I should see "Transportation" in the ".name" element
