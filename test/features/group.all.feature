...
Feature: Site Manager administer groups
  ...
  Background:
    ...
    And datasets:
      ...
      | Dataset 01 | Group 01  | world        | Katie   | Yes       | Increase of toy prices     | 10 September 2015 | Education      |
      | Dataset 02 | Group 01  | world        | Katie   | No        | Cost of oil in January     | 10 September 2015 | Education      |
      | Dataset 03 | Group 01  | results      | Gabriel | Yes       | Election results           | 17 October 2015   | Education      |
    ...
    And resources:
      ...
      | Resource 02 | Group 01  | zip    | Katie  | Yes       | Dataset 03 |             |
  ...
  Scenario: View available "resource format" filters after search
    ...
    And I should see "zip (1)" in the "filter by resource format" region
  ...
  Scenario: View available "tag" filters after search
    ...
    When I fill in "Dataset" for "Search" in the "content" region
    And I press "Apply"
    Then I should see "world (1)" in the "filter by tag" region
    And I should see "results (1)" in the "filter by tag" region
  ...
  Scenario: Filter datasets on group by tags
    ...
    When I fill in "Dataset" for "Search" in the "content" region
    And I press "Apply"
    When I click "world" in the "filter by tag" region
    Then I wait for "1 datasets"
