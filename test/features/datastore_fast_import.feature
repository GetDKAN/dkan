...
Feature: DKAN Datastore Fast Import
  ...
  @datastore @datastore_fast_import @datastore_fast_import_1
  Scenario: As user I want to import files using batch imports
    Given I am logged in as a user with the "site manager" role
      And I am on "Datastore Settings" page
      And I select the radio button "Use regular import as default (BATCH)"
  ...
  @datastore @datastore_fast_import @datastore_fast_import_2
  Scenario: As user I want to import files using fast import even when not enabled globally
    Given I am logged in as a user with the "site manager" role
      And I am on "Datastore Settings" page
      And I select the radio button "Use regular import as default (BATCH)"
      And I press "Save configuration"
  ...
  @datastore @datastore_fast_import @datastore_fast_import_3
  Scenario: As user I want to set fast imports as default for all resources
    Given I am logged in as a user with the "site manager" role
    And I am on "Datastore Settings" page
  ...
  @datastore @datastore_fast_import @datastore_fast_import_4
  ...
  @datastore @datastore_fast_import @datastore_fast_import_5
  ...
  @datastore @datastore_fast_import @datastore_fast_import_6
