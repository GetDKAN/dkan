...
namespace Drupal\dkan\LifeCycle;
...
use Drupal\dkan\Reference\Dereferencer;
use Drupal\dkan\Reference\OrphanChecker;
use Drupal\dkan\Reference\Referencer;
...
class LifeCycle {
   ...
   * Referencer service.
   *
   * @var \Drupal\dkan\Reference\Referencer
   */
   ...
   * Dereferencer.
   *
   * @var \Drupal\dkan\Reference\Dereferencer
   */
   ...
   *
   * @var \Drupal\dkan\Reference\OrphanChecker
   */
   ...
   * @param Drupal\dkan\MetastoreItemInterface $data
