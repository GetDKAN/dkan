...
namespace Drupal\dkan\Form;

use Drupal\Core\Form\ConfigFormBase;
use Drupal\Core\Form\FormStateInterface;
use Drupal\Core\Routing\RouteBuilderInterface;
use Drupal\dkan\SchemaPropertiesHelper;
use Symfony\Component\DependencyInjection\ContainerInterface;

/**
 * Metastore data settings form.
 *
 * @package Drupal\dkan\Form
 * @codeCoverageIgnore
 */
class DkanDataSettingsForm extends ConfigFormBase {
   ...
   *
   * @var \Drupal\dkan\SchemaPropertiesHelper
   */
   ...
   * Constructs form.
   *
   * @param \Drupal\dkan\SchemaPropertiesHelper $schemaHelper
