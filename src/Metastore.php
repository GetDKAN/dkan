...
use Drupal\dkan\EventDispatcherTrait;
use Drupal\dkan\LoggerTrait;
use Drupal\dkan\Exception\CannotChangeUuidException;
use Drupal\dkan\Exception\ExistingObjectException;
use Drupal\dkan\Exception\MissingObjectException;
use Drupal\dkan\Exception\UnmodifiedObjectException;
use Drupal\dkan\Storage\DataFactory;
use Drupal\dkan\Storage\MetastoreStorageInterface;
 ...
 */
class Metastore implements ContainerInjectionInterface {
   ...
   * Schema retriever.
   *
   * @var \Drupal\dkan\SchemaRetriever
   */
   ...
   * Storage factory.
   *
   * @var \Drupal\dkan\Storage\MetastoreStorageFactoryInterface
   */
   ...
   *
   * @var \Drupal\dkan\ValidMetadataFactory
   */
   ...
   *
   * @return \Drupal\dkan\Storage\MetastoreStorageInterface
   *   Entity storage.
   */
   ...
   *
   * @return \Drupal\dkan\ValidMetadataFactory
   ...
   *
   * @throws \Drupal\dkan\Exception\InvalidJsonException
   */
