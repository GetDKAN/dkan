...
use Drupal\dkan\Factory\MetastoreItemFactoryInterface;
...
class MetastoreApiResponse {
   ...
   * Constructor.
   *
   * @param \Drupal\dkan\Factory\MetastoreItemFactoryInterface $metastoreItemFactory
   ...
   * @param \Drupal\Core\Cache\CacheableMetadata $cacheMetadata
   *   Cache metadata object.
   * @param \Drupal\dkan\MetastoreItemInterface $item
   ...
   *
   * @return \Drupal\dkan\Factory\MetastoreItemFactoryInterface
