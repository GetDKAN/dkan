...
namespace Drupal\dkan\EventSubscriber;

use Drupal\dkan\Events\Event;
use Drupal\dkan\DataResource;
use Drupal\Core\Logger\LoggerChannelFactory;
use Symfony\Component\EventDispatcher\EventSubscriberInterface;
use Drupal\dkan\Plugin\QueueWorker\OrphanReferenceProcessor;
...
class MetastoreSubscriber implements EventSubscriberInterface {
   ...
   * @param \Drupal\dkan\Metastore $service
   *   The dkan.metastore.service service.
   * @param \Drupal\dkan\ResourceMapper $resourceMapper
   *   The dkan.metastore.resource_mapper.
   */
  public function __construct(LoggerChannelFactory $logger_factory, Metastore $service, ResourceMapper $resourceMapper) {
