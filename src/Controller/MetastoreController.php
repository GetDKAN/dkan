...
namespace Drupal\dkan\Controller;

use Drupal\dkan\JsonResponseTrait;
use Drupal\dkan\Exception\CannotChangeUuidException;
use Drupal\dkan\Exception\InvalidJsonException;
use Drupal\dkan\Exception\MetastoreException;
use Drupal\dkan\Exception\MissingPayloadException;
use Symfony\Component\HttpFoundation\JsonResponse;
use Symfony\Component\HttpFoundation\Request;
use Symfony\Component\DependencyInjection\ContainerInterface;
use Drupal\Core\DependencyInjection\ContainerInjectionInterface;
use Drupal\dkan\MetastoreApiResponse;
...
class MetastoreController implements ContainerInjectionInterface {
   ...
   *
   * @var \Drupal\dkan\DatasetApiDocs
   */
  private $docs;
   ...
   * Constructor.
   */
  public function __construct(MetastoreApiResponse $apiResponse, Metastore $service) {
  ...
  public function get(string $schema_id, string $identifier, Request $request) {
    try {
      ...
      if ($this->wantObjectWithReferences($request)) {
        ...
        $object = Metastore::removeReferences($object);
      }
