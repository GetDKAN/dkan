...
.. image:: https://dkan-documentation-files.s3.us-east-2.amazonaws.com/dkan1/choropleth-step-00.png

+ Fill the required fields, enter 'geojson' in the format field, and **save** the resource

.. image:: https://dkan-documentation-files.s3.us-east-2.amazonaws.com/dkan1/choropleth-step-01.png

+ Look for **Structure -> Entity Types -> Geo File -> geojson -> Add geojson** in the admin menu and click on it.

.. image:: https://dkan-documentation-files.s3.us-east-2.amazonaws.com/dkan1/choropleth-step-02.png
...
.. image:: https://dkan-documentation-files.s3.us-east-2.amazonaws.com/dkan1/choropleth-step-03.png

+ Click **Save**.
+ You'll get a preview for the geojson file you just uploaded.

.. image:: https://dkan-documentation-files.s3.us-east-2.amazonaws.com/dkan1/choropleth-step-04.png
...
.. image:: https://dkan-documentation-files.s3.us-east-2.amazonaws.com/dkan1/choropleth-step-05.png

+ Fill Title
+ Select the **geojson** file we created for the **geojson** field.
+ Select the **resource** file we created for the **resource** field.

.. image:: https://dkan-documentation-files.s3.us-east-2.amazonaws.com/dkan1/choropleth-step-06.png
...
.. image:: https://dkan-documentation-files.s3.us-east-2.amazonaws.com/dkan1/choropleth-step-07.png

+ Click **Save** & Enjoy!

.. image:: https://dkan-documentation-files.s3.us-east-2.amazonaws.com/dkan1/choropleth-step-08.png
