...
* **DKAN Dataset Rest API** defines a REST endpoint via the `Services <https://www.drupal.org/project/services>`_ module, exposing full CRUD operations to authenticated 3rd-party apps and services
