...
Get more details on DKAN Harvest by reading its [documentation pages](https://docs.getdkan.com/en/latest/components/harvest.html).
...
Get more details on the [Dataset REST API](https://docs.getdkan.com/en/latest/apis/rest-api.html).
...
Get more details on [Federal Extras](https://docs.getdkan.com/en/latest/components/federal-extras.html) on DKAN.
...
Get more details on the [Datastore API](https://docs.getdkan.com/en/latest/apis/datastore-api.html)
...
**WARNING:** The [EVA](https://drupal.org/project/eva) is removed with this release. If you are using EVA in your project you need to add it to your `sites/all/modules` folder.
