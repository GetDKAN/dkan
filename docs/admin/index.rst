...
**Data and content:** One of the biggest pieces of a Granicus Open Data site is of course the data itself. A Site Manager can decide how users can add data and create content, and use special visual tools to showcase the stories and insights gained from datasets. 
