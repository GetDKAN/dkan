...
/**
 * @file
 * dkan_sitewide_panels.views_default.inc
 */

/**
 * Implements hook_views_default_views().
 */
function dkan_sitewide_panels_views_default_views() {
  $export = array();

  $view = new view();
  $view->name = 'dkan_datasets';
  $view->description = '';
  $view->tag = 'default';
  $view->base_table = 'search_api_index_datasets';
  $view->human_name = 'DKAN Datasets';
  $view->core = 7;
  ...
  $handler->display->display_options['filters']['search_api_views_fulltext']['expose']['description'] = 'Search...';
  ...
  $handler->display->display_options['filters']['type']['table'] = 'search_api_index_datasets';
  ...
  $export['dkan_datasets'] = $view;

  $view = new view();
  $view->name = 'dkan_datasets_filtered';
  $view->description = '';
  $view->tag = 'default';
  $view->base_table = 'node';
  $view->human_name = 'DKAN Datasets Filtered';
  $view->core = 7;
  $view->api_version = '3.0';
  $view->disabled = FALSE; /* Edit this to true to make a default view disabled initially */
  ...
  $handler->display->display_options['header']['result']['table'] = 'views';
  $handler->display->display_options['header']['result']['field'] = 'result';
  $handler->display->display_options['header']['result']['content'] = '@total dataset(s)';
  /* No results behavior: Global: Text area */
  $handler->display->display_options['empty']['area']['id'] = 'area';
  $handler->display->display_options['empty']['area']['table'] = 'views';
  $handler->display->display_options['empty']['area']['field'] = 'area';
  $handler->display->display_options['empty']['area']['empty'] = TRUE;
  $handler->display->display_options['empty']['area']['content'] = 'Sorry, no datasets match your selections.';
  ...
  /* Display: Custom Filtered Dataset List */
  $handler = $view->new_display('panel_pane', 'Custom Filtered Dataset List', 'panel_pane_1');
  $handler->display->display_options['defaults']['filter_groups'] = FALSE;
  $handler->display->display_options['defaults']['filters'] = FALSE;
  /* Filter criterion: Content: Published */
  $handler->display->display_options['filters']['status']['id'] = 'status';
  ...
  $handler->display->display_options['filters']['og_group_ref_target_id_entityreference_filter']['group'] = 1;
  $handler->display->display_options['filters']['og_group_ref_target_id_entityreference_filter']['exposed'] = TRUE;
  $handler->display->display_options['filters']['og_group_ref_target_id_entityreference_filter']['expose']['operator_id'] = 'og_group_ref_target_id_entityreference_filter_op';
  $handler->display->display_options['filters']['og_group_ref_target_id_entityreference_filter']['expose']['label'] = 'Group';
  $handler->display->display_options['filters']['og_group_ref_target_id_entityreference_filter']['expose']['operator'] = 'og_group_ref_target_id_entityreference_filter_op';
  ...
  $handler->display->display_options['filters']['og_group_ref_target_id_entityreference_filter']['expose']['remember_roles'] = array(
    2 => '2',
    1 => 0,
    4 => 0,
    3 => 0,
  );
  $handler->display->display_options['filters']['og_group_ref_target_id_entityreference_filter']['expose']['hide_empty_filter'] = FALSE;
  $handler->display->display_options['filters']['og_group_ref_target_id_entityreference_filter']['reference_display'] = 'entity_reference_groups_list:entityreference_1';
  $handler->display->display_options['filters']['og_group_ref_target_id_entityreference_filter']['reference_arguments'] = '!n';
  /* Filter criterion: Content: Tags (field_tags) */
  $handler->display->display_options['filters']['field_tags_tid']['id'] = 'field_tags_tid';
  $handler->display->display_options['filters']['field_tags_tid']['table'] = 'field_data_field_tags';
  $handler->display->display_options['filters']['field_tags_tid']['field'] = 'field_tags_tid';
  ...
  $export['dkan_datasets_filtered'] = $view;

  $view = new view();
  $view->name = 'dkan_groups';
  $view->description = '';
  $view->tag = 'default';
  $view->base_table = 'node';
  $view->human_name = 'DKAN Groups';
  $view->core = 7;
  $view->api_version = '3.0';
  $view->disabled = FALSE; /* Edit this to true to make a default view disabled initially */
  ...
  $handler->display->display_options['style_options']['column_classes'] = 'grid-4 col-sm-12 col-md-4';
  ...
  /* Display: Block */
  $handler = $view->new_display('block', 'Block', 'block_1');
  $export['dkan_groups'] = $view;

  $view = new view();
  $view->name = 'entity_reference_groups_list';
  $view->description = '';
  $view->tag = 'default';
  $view->base_table = 'node';
  $view->human_name = 'Entity Reference Groups List';
  $view->core = 7;
  $view->api_version = '3.0';
  $view->disabled = FALSE; /* Edit this to true to make a default view disabled initially */
  ...
  $export['entity_reference_groups_list'] = $view;
