  ...
  private function datastoreStateToString($state) {
    switch ($state) {
      ...
      case ManagerInterface::DATA_IMPORT_PAUSED:
        drupal_set_message(t("The datastore importer is currently paused. It will resume in the background the next time cron runs from drush. See the documentation for more information."));
        return t("Paused");
