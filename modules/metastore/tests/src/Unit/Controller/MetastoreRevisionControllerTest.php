...
use Drupal\metastore\Controller\MetastoreRevisionController;
 ...
 *
 */
class MetastoreRevisionControllerTest extends TestCase {
  ...
  public function testGetAll() {
    ...
    $controller = MetastoreRevisionController::create($mockChain->getMock());
