...
class MetadataAccessControlHandler extends EntityAccessControlHandler {
  ...
  protected function checkAccess(EntityInterface $entity, $operation, AccountInterface $account) {
    ...
    switch ($operation) {
      case 'view':
        return AccessResult::allowedIfHasPermission($account, 'view metadata entity');

      case 'update':
        return AccessResult::allowedIfHasPermission($account, 'edit metadata entity');

      case 'delete':
        return AccessResult::allowedIfHasPermission($account, 'delete metadata entity');
    }
