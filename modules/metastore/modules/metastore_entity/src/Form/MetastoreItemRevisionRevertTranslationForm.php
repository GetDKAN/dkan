...
/**
 * Provides a form for reverting a Metastore item revision for a single trans.
 *
 * @ingroup metastore_entity
 */
class MetastoreItemRevisionRevertTranslationForm extends MetastoreItemRevisionRevertForm {
  ...
  public function getFormId() {
    return 'metastore_item_revision_revert_translation_confirm';
  }
   ...
   * {@inheritdoc}
   */
  public function buildForm(array $form, FormStateInterface $form_state, $metastore_item_revision = NULL, $langcode = NULL) {
    $this->langcode = $langcode;
    $form = parent::buildForm($form, $form_state, $metastore_item_revision);
