...
/**
 * Provides a list controller for metastore_entity entity.
 *
...
class MetadataListBuilder extends EntityListBuilder {
  ...
  /**
   * Constructs a new MetadataListBuilder object.
   *
   ...
   * {@inheritdoc}
   *
   * Building the header and content lines for the metadata list.
   *
