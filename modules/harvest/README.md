...
The **harvest** module provides integration with the [harvest](https://github.com/GetDKAN/harvest) library. This enables you to use the public feed or API of another data portal and import items from that portal’s catalog into your own.
...
| dkan-harvest:register     | $config      | Register a new harvest, file saved to the *harvest/plans* directory. |
