...
class IndexFieldValues {
  ...
  public static function updateIndexFieldValues($field_index, $update_values, $current_index_fields) {
    $name = $update_values["field_json_metadata"][0]["dictionary_fields"]["edit_fields"][$field_index]["name"];
    $length = $update_values["field_json_metadata"][0]["dictionary_fields"]["edit_fields"][$field_index]["length"];
