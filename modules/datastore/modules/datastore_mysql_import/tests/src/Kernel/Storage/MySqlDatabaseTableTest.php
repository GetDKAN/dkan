...
namespace Drupal\Tests\dastastore_mysql_import\Kernel\Storage;
...
class MySqlDatabaseTableKernelTest extends KernelTestBase {
  ...
  public function testTableExistsException() {
    ...
    $this->assertEquals('datastore_identifier', $database_table->getTableName());
    $this->assertTrue($connection->schema()->tableExists($database_table->getTableName()), 'Table does not exist: ' . $database_table->getTableName());

//    $this->assertEquals(['a', 'thing'], $database_table->getSchema()['fields']);
