...
class Drush extends DrushCommands {
   ...
   *
   * @deprecated in dkan:2.14.0 and is removed from dkan:3.0.0. Use dkan:datastore:import instead.
   ...
   *
   * @deprecated in dkan:2.14.0 and is removed from dkan:3.0.0. Use dkan:datastore:list instead.
   * @see https://github.com/GetDKAN/dkan/releases/tag/2.14.0
   */
   ...
   *
   * @deprecated in dkan:2.14.0 and is removed from dkan:3.0.0. Use dkan:datastore:drop instead.
   * @see https://github.com/GetDKAN/dkan/releases/tag/2.14.0
   */
