...
class CommonCommands extends DrushCommands {
  ...
  public function datatableToResourceLookup(string $data_table_name) {
    if ($data_table_name) {
      ...
      if ($resource_result) {
        ...
        return "Can not map data table name " . $data_table_name . " to resource ID.";
      }
    }
  }
  ...
  public function resourceToDistribution(string $resource_id) {
    if ($resource_id) {
      ...
      if ($distribution_result) {
        ...
        return "Can not map resource ID " . $resource_id . " to distribution UUID.";
      }
    }
  }
  ...
  public function distributionToDataset(string $distribution_uuid) {
    if ($distribution_uuid && strlen($distribution_uuid) == 36) {
      ...
      if ($dataset_result) {
        ...
        return "Cannot map distribution UUID " . $distribution_uuid . " to dataset UUID.";
      }
    }
    return "Distribution ID needs to be 36 characters.";
  }
  ...
  public function reverseDatasetLookup(string $data_table_name) {
    ...
    if ($distribution_uuid) {
      ...
      $this->output()->writeln('Dataset UUID:' . PHP_EOL . $dataset_uuid);
