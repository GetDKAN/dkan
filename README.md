# DKAN
An Open Data Catalog module for [Drupal 10/11](https://www.drupal.org/documentation)
...
## Documentation
DKAN's full documentation can be found at [dkan.readthedoc.io](https://dkan.readthedocs.io/en/4.x).
