...
class DatasetTest extends ExistingSiteBase {
  ...
  public function test2() {
    ...
    $ref = &drupal_static('metastore_dereference_method');
    $ref = Dereferencer::DEREFERENCE_OUTPUT_DEFAULT;
  ...
  private function checkDatasetIn($datasetJson, $method = 'post', $downloadUrl = null) {
    ...
    drupal_static('metastore_resource_mapper_info', ResourceMapper::DEREFERENCE_YES);
    ...
    return $datasetWithReferences->distribution[0]->data->downloadURL->data;
  }
